...
OBJECTS += ./libHttp/http_parser/http_parser.o
OBJECTS += ./libThingSpeak/WString.o
OBJECTS += ./libThingSpeak/itoas.o
OBJECTS += ./libThingSpeak/time.o
OBJECTS += ./main.o
...
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I.././libHttp
INCLUDE_PATHS += -I.././libHttp/http_parser
INCLUDE_PATHS += -I.././libThingSpeak
...
INCLUDE_PATHS += -I../E:/Projects/mbed-os-example-blinky/mbed-os
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1560695700.3
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1560695700.3
...
ASM_FLAGS += -I..
ASM_FLAGS += -I..\libHttp
ASM_FLAGS += -I..\libHttp\http_parser
ASM_FLAGS += -I..\libThingSpeak
ASM_FLAGS += -I..\mbed-os
...
ASM_FLAGS += -I..\mbed-os\features\netsocket\emac-drivers\TARGET_STM_EMAC
ASM_FLAGS += -I..\mbed-os\features\nvstore
ASM_FLAGS += -I..\mbed-os\features\nvstore\source
...
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F7
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F7\TARGET_STM32F767xI
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F7\TARGET_STM32F767xI\TARGET_NUCLEO_F767ZI
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F7\TARGET_STM32F767xI\device
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F7\device
ASM_FLAGS += -IE:\Projects\mbed-os-example-blinky\mbed-os
ASM_FLAGS += -include
